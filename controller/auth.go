...
func (*authController) checkAdminInitStatus(db *repo.Database) http.HandlerFunc {
...
func (*authController) saveAdminProfile(db *repo.Database) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if user.Password == "" {
			...
			if err := db.SaveUserDetails(user); err != nil {
...
func (*authController) login(db *repo.Database) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
